...
import {
  getLeaveProposalHistoryDetailForHr,
  getLeaveProposalHistoryForHr,
  getOvertimeSubmissionHistoryDetailForHr,
  getOvertimeSubmissionHistoryForHr,
} from "../../../../app/services/api/proposal";
import { getEmployeesAttendancesLog } from "../../../../app/services/api/attendance";
...
export default function HistoryModel() {
  ...
  const fetchLeaveDetail = (id) => {
    ...
    getLeaveProposalHistoryDetailForHr(id)
      .then((data) => {
        setLeaveDetail(data);
      })
      .catch((err) => {
  ...
  const fetchOvertimeDetail = (id) => {
    ...
    getOvertimeSubmissionHistoryDetailForHr(id)
      .then((data) => {
