...
export default function EmployeeDetailView() {
  const { values, handlers, fetchers, refs } = EmployeeDetailModel();
  ...
  }, [values.leaves.query, values.overtimes.query, values.attendances.query]);
  ...
  return (
    <>
      <div className="flex flex-col gap-6">
        <div className="body-container">
          <div className="flex flex-row justify-between w-full mb-8">
            <button
              type="button"
              className="btn btn-ghost-neuro normal-case"
            ...
            <button
              ...
              onClick={handlers.updates.open}
              disabled={
                values.detail?.resignDate != null ||
                values.detail?.status === "RESIGNED"
              }
            >
              Update
            </button>
              ...
              <>
                ...
                <div className="flex flex-row gap-2 mb-4 items-center">
                  ...
                  <div className="dropdown dropdown-start">
                    ...
                    >
                      <p className="text-secondary-normal dark:text-white font-bold">
                        Status
                      </p>
      ...
      >
        <div
          className={`border-t-2 border-slate-300 dark:border-slate-700 flex flex-col gap-4 mt-6 ${
            values.updates.loading && "h-32"
          }`}
        >
          <div
            className="relative top-[-15px] left-1/2 bg-white dark:bg-slate-700  w-fit px-8 text-slate-400"
          ...
          {values.updates.loading ? (
            ...
            <>
              ...
              <div className="form-control gap-1">
                ...
                <select
                  className="select select-bordered form-background select-md select-ghost w-full"
                  id="employment-select"
                  onChange={handlers.updates.contractType}
                  value={values.updates.contractType}
                >
                  <option disabled value="">
              ...
              <div className="form-control gap-1">
                ...
                <select
                  className="select select-bordered form-background select-md select-ghost w-full "
                  id="job-select"
                  onChange={handlers.updates.job}
                  value={values.updates.jobId}
                >
                  <option disabled value="">
                    Select a job
                  </option>
                  {values.updates.jobs.map((item) => (
              ...
              <div className="form-control gap-1">
                ...
                <select
                  className="select select-bordered form-background select-md select-ghost w-full"
                  id="role-select"
                  onChange={handlers.updates.role}
                  value={values.updates.roleId}
                >
                  <option disabled value="">
                    Select a role
                  </option>
                  {values.updates.roles.map((item) => (
                    <option key={item.id} value={item.id}>
                      {item.name}
                    </option>
                  ))}
              ...
              <div className="form-control gap-1">
                ...
                <select
                  className="select select-bordered form-background select-md select-ghost w-full"
                  id="manager-select"
                  onChange={handlers.updates.manager}
                  value={values.updates.managerId}
                  ref={refs.manager}
                >
                  <option disabled value="">
                    Select a manager
                  </option>
                  {values.updates.managers.map((item) => (
                    <option key={item.id} value={item.id}>
              ...
              <div className="form-control gap-1">
                ...
                <select
                  className="select select-bordered form-background select-md select-ghost w-full"
                  id="manager-select"
                  onChange={handlers.updates.status}
                  value={values.updates.status}
                >
                  <option disabled value="">
                    Select a status
                  </option>
              ...
              <button
                ...
                onClick={handlers.updates.submit}
                disabled={values.updates.disabled}
              >
                Update
              </button>
              <button
                type="button"
                className="btn btn-ghost-neuro w-full text-white normal-case"
                onClick={handlers.updates.close}
              >
                Close
              </button>
            </>
