        ...
        <div className="flex md:flex-row md:self-end md:gap-4 flex-col gap-2">
          ...
          <form onSubmit={handlers.submit}>
            <div className="join w-40 md:w-fit">
              <input
                className="input input-bordered body-container-color-button join-item md:w-40 w-28"
          ...
          <div className="form-control">
            <select
              className="select select-bordered body-container-color-button font-extrabold md:w-fit w-40"
